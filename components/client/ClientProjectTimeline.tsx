...
import { CheckCircle2, Circle, Loader2, MinusCircle, PlayCircle } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
import type { ProjectStep, ProjectStepStatus, ProjectStepPatch } from "@/types";
                ...
                <li key={step.key} className="relative flex gap-3 pb-5">
                  ...
                  <div className="min-w-0 flex-1 pt-0.5">
                    ...
                    {editable && onUpdateStep && (
                      <div className="mt-2 grid gap-2 sm:grid-cols-[140px_1fr_1fr] sm:items-center">
                        <Select
                          value={step.status}
                          onValueChange={(value) => {
