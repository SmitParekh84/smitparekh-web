...
// Animated, interactive canvas grid (ported from React Bits "ShapeGrid" to TSX).
// Draws a scrolling grid of shapes; cells fill on hover with an optional fading
// trail. Colors are passed in so they can follow the brand / theme.
