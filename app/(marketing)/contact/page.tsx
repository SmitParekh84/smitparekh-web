            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 text-sm text-muted-foreground">
                  ...
                  India &middot; Gulf &amp; Worldwide
                </div>
              </div>

              {/* Gulf timezone note */}
              <div className="rounded-2xl border border-blue-200 bg-blue-50/60 dark:border-blue-900/40 dark:bg-blue-950/20 p-4">
                <p className="text-xs font-semibold uppercase tracking-widest text-blue-600 dark:text-blue-400 mb-1.5">
                  Gulf / GCC Clients
                </p>
                ...
                {siteConfig.whatsapp && (
                  <a
                    ...
                    className="mt-3 inline-flex items-center gap-2 rounded-lg bg-[#25D366] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#1ebe5d] transition-colors"
                  >
