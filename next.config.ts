...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://www.smitparekh.co.in https://api.smitparekh.co.in https://*.vercel.app https://*.supabase.co wss://*.supabase.co https://*.hf.space http://localhost:5000 https://www.google-analytics.com https://region1.google-analytics.com https://www.googletagmanager.com https://badges.linkedin.com https://platform.linkedin.com https://pagead2.googlesyndication.com https://adservice.google.com https://googleads.g.doubleclick.net https://*.adtrafficquality.google https://app.cal.com https://cal.com https://embed.cal.com https://api.razorpay.com https://lumberjack.razorpay.com",
