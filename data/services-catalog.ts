...
export const servicePages: ServicePage[] = [
  ...
  // ---------------------------------------------------------------- WEBSITE MAINTENANCE
  {
    ...
    proof: [
      { value: "30+", label: "Sites on active maintenance retainer" },
      { value: "99.9%", label: "Uptime target on all monitored client sites" },
      { value: "48h", label: "Full triage turnaround on non-critical fixes" },
      { value: "<1h", label: "Initial response to priority production issues" },
    ],
    pricing: [
  ...
  // ---------------------------------------------------------------- ON-PAGE SEO
  {
    ...
    category: "marketing",
    iconName: "Search",
    metaTitle: "On-Page SEO Services - Title Tags, Meta, Content Optimisation",
    metaDescription:
      "On-page SEO across your full site: title tags, meta descriptions, H1-H3 hierarchy, internal linking, content updates, and keyword targeting. Developer-led, not outsourced.",
    keywords: [
    ...
    eyebrow: "On-Page SEO",
    heroTitle: "Every page optimised for what people actually search",
    heroDescription:
      "Title tags, meta descriptions, H1-H3 hierarchy, internal linking, and content structure — done across every page, scaled via templates so new pages inherit it automatically.",
    lede: "Most sites lose rankings not because of backlinks but because on-page signals are mediocre: generic titles, weak H1s, and content that doesn't match search intent. On-page fixes are the fastest lever — they're entirely under your control and the results show up in weeks, not months.",
    deliverables: [
      { iconName: "FileSearch", title: "Title & meta template system", description: "Pattern-based title and description templates by page type — homepage, service, blog, product — so every page gets unique, keyword-targeted meta without manual effort." },
      { iconName: "Search", title: "H1-H6 structure audit & fix", description: "One focused H1 per page that matches search intent, logical H2/H3 hierarchy for featured-snippet eligibility, and keyword placement that reads naturally — not stuffed." },
      { iconName: "TrendingUp", title: "Keyword targeting by page type", description: "Intent-matched keyword mapping: transactional on service pages, informational on blog posts. Clear primary and secondary targets per URL, not a keyword list that nobody uses." },
      { iconName: "Layers", title: "Internal linking architecture", description: "Hub-and-spoke link structure from high-authority pages to targets you want to rank. Contextual anchor text updated in the CMS or template layer." },
      { iconName: "Sparkles", title: "Content refresh recommendations", description: "SERP analysis for priority pages: what currently ranks, what the intent really is, and what your content needs to add, cut, or rewrite to compete." },
      { iconName: "BarChart3", title: "GSC CTR analysis", description: "Pages with impressions but low CTR get title/description rewrites first — the fastest organic traffic you can earn without new content or links." },
    ],
    techStack: [
      { label: "Research", items: ["Ahrefs", "Search Console", "Screaming Frog", "SurferSEO"] },
      { label: "Implementation", items: ["Next.js metadata API", "CMS templates", "JSON-LD", "Sitemap"] },
      { label: "Content", items: ["ContentHarmony", "Clearscope", "Hemingway", "Grammarly"] },
      { label: "Reporting", items: ["GA4", "Search Console", "Looker Studio", "Ahrefs Rank Tracker"] },
    ],
    process: [
      { title: "Crawl & CTR audit", description: "Full crawl for missing/duplicate meta, GSC export for impressions-vs-CTR outliers. Prioritised list of highest-impact pages to fix first." },
      { title: "Template & map", description: "Title/description templates per page type, keyword map per URL, internal link plan. Everything written before a single character is changed." },
      { title: "Implement", description: "Templates applied across the site in code or CMS. All changes tracked in a changelog so you know exactly what was touched." },
      { title: "Monitor & refine", description: "Monthly CTR and ranking check. Titles that don't move get tested; internal links that don't pass equity get reviewed." },
    ],
    proof: [
      { value: "+25%", label: "Median CTR improvement after title/meta rewrite" },
      { value: "100%", label: "Pages with unique, targeted titles after audit" },
      { value: "48h", label: "Typical implementation turnaround for 50-page sites" },
      { value: "No guessing", label: "Every change tied to a GSC data point or SERP analysis" },
    ],
    pricing: [
      { name: "Audit + Plan", startingFrom: "$450", bestFor: "Up to 50 pages", bullets: ["Full on-page audit", "Keyword map per URL", "Title/meta rewrites delivered"] },
      { name: "Audit + Implement", startingFrom: "$1,800", popular: true, bestFor: "Sites up to 150 pages", bullets: ["Audit + full implementation in code or CMS", "Internal link plan wired", "GSC monitoring setup"] },
      { name: "Retainer", startingFrom: "$900/mo", bestFor: "Ongoing content-driven growth", bullets: ["New-page on-page optimisation", "Monthly CTR + ranking review", "Content briefs included"] },
    ],
    faqs: [
      { q: "How is on-page SEO different from technical SEO?", a: "Technical SEO is about how search engines crawl and index your site — speed, schema, rendering. On-page SEO is about what's on each page: titles, headings, content relevance, and internal links. Both matter; they fix different things." },
      { q: "How quickly do on-page changes affect rankings?", a: "Faster than most people expect. Googlebot recrawls pages with new content within days to 2 weeks. CTR changes from better titles can show in Search Console within a week of recrawl." },
      { q: "Do you write the content or just advise?", a: "Both options are available. I audit and recommend what to change, and I can write the revised content or work with your team. The plan is delivered in a doc you can act on regardless of who implements it." },
      { q: "What if my site is on WordPress / Webflow / Shopify?", a: "All of them. I implement in whatever CMS or framework you use - from Next.js metadata API to Yoast to Webflow's built-in fields. The templates are adapted for your platform." },
    ],
    related: ["seo", "technical-seo", "content-seo", "seo-audit"],
  },
  ...
  // ---------------------------------------------------------------- AEO OPTIMIZATION
  {
    ...
    category: "marketing",
    iconName: "TrendingUp",
    metaTitle: "AEO Optimization - Get Cited in ChatGPT, Perplexity & AI Search",
    metaDescription:
      "Answer Engine Optimization to get your brand cited in ChatGPT, Claude, Perplexity, and Google AI Overviews. Structured content that AI engines trust and quote.",
    keywords: [
      "AEO optimization",
      "answer engine optimization",
      "ChatGPT SEO",
    ...
    eyebrow: "AEO Optimization",
    heroTitle: "Get your brand inside AI answers, not just Google results",
    heroDescription:
      "Answer Engine Optimization targets ChatGPT, Claude, Perplexity, and Google AI Overviews — the places your customers are now getting answers instead of clicking blue links.",
    lede: "When someone asks ChatGPT to recommend a tool or service in your category, your competitors are getting named and you are not. AEO is the work that fixes that: structured authority content, entity relationships, and citation-ready data that LLMs pull from and attribute.",
    deliverables: [
      { iconName: "Sparkles", title: "AI visibility audit", description: "Benchmark your current citation rate in ChatGPT, Perplexity, Claude, and Gemini for your priority queries. This is baseline — the number we grow from." },
      { iconName: "FileSearch", title: "Question-and-answer content", description: "Authoritative, directly-answerable content per target query. Structured to match how LLMs extract citations: clear claims, attributable sources, specific entities." },
      { iconName: "Layers", title: "Entity & brand signal building", description: "Wikipedia-equivalent entity coverage — consistent brand mentions across authoritative sources so LLMs recognize you as a real, trustworthy entity." },
      { iconName: "Webhook", title: "Schema & structured data for AI", description: "FAQ, HowTo, Article, and Organization schema markup that makes your content machine-readable — the format AI engines prefer when extracting answers." },
      { iconName: "TrendingUp", title: "Topic authority content clusters", description: "Comprehensive content on the questions in your space. LLMs cite what they trust, and trust is built by covering a topic thoroughly from multiple angles." },
      { iconName: "BarChart3", title: "Citation tracking & reporting", description: "Monthly tracking of citation frequency across AI platforms for your target queries. Measurable, not anecdotal." },
    ],
    techStack: [
      { label: "Audit", items: ["ChatGPT", "Perplexity", "Claude", "Gemini"] },
      { label: "Content", items: ["Question research", "Entity mapping", "SurferSEO", "Clearscope"] },
      { label: "Schema", items: ["JSON-LD", "FAQ schema", "HowTo schema", "Organization"] },
      { label: "Tracking", items: ["Manual AI queries", "Perplexity API", "Brand monitoring", "Search Console"] },
    ],
    process: [
      { title: "AI visibility baseline", description: "Systematic prompting across ChatGPT, Perplexity, Claude, and Gemini for your top-20 category queries. Current citation rate documented." },
      { title: "Content gap & entity map", description: "What questions LLMs answer about your category, which entities they cite, and where your brand is missing from the conversation." },
      { title: "Content & schema build", description: "Q&A content, topic clusters, and schema markup targeting your gap queries — all structured for AI extractability." },
      { title: "Track & iterate", description: "Monthly re-baseline across AI platforms. New queries added, underperforming content revised, citation trends reported." },
    ],
    proof: [
      { value: "4 platforms", label: "ChatGPT, Perplexity, Claude & Gemini tracked" },
      { value: "Cited", label: "Goal: brand appears in category-query AI answers" },
      { value: "Structured", label: "Every content piece built for AI extractability" },
      { value: "Monthly", label: "Citation rate reported — not anecdotal" },
    ],
    pricing: [
      { name: "AEO Audit", startingFrom: "$600", bestFor: "Baseline + action plan", bullets: ["AI citation baseline across 4 platforms", "Gap analysis vs competitors", "Prioritised content plan"] },
      { name: "AEO Sprint", startingFrom: "$3,000", popular: true, bestFor: "6-week citation push", bullets: ["Audit + 10 Q&A content pieces", "Entity & schema implementation", "Monthly citation tracking"] },
      { name: "Retainer", startingFrom: "$1,600/mo", bestFor: "Ongoing AI search growth", bullets: ["4 content pieces/mo", "Monthly citation report", "Schema + entity upkeep"] },
    ],
    faqs: [
      { q: "Is AEO different from traditional SEO?", a: "Yes. Traditional SEO targets Google's 10 blue links — ranking factors are page speed, backlinks, and keyword relevance. AEO targets AI-generated answers — factors are content authority, entity recognition, and structured extractability. You need both, but they require different work." },
      { q: "Can you guarantee my brand gets cited by ChatGPT?", a: "No guarantee — LLMs are probabilistic and their citation behavior changes as they're updated. What I can guarantee is a systematic program that builds the content and entity signals that increase citation probability, and monthly tracking that shows whether it's working." },
      { q: "How is AEO different from GEO?", a: "AEO is broader — it covers all AI answer engines (ChatGPT, Perplexity, Claude, Gemini). GEO specifically targets Google's AI Overviews (the AI-generated answer at the top of Google results). Both overlap significantly but GEO work is tied to Google's specific algorithms and your existing GSC performance." },
      { q: "How quickly will I see results?", a: "Citation frequency changes happen over 2-4 months as new content gets indexed and picked up by LLM training or retrieval systems. Perplexity-style retrieval engines pick up new content faster than model-training-based citations." },
    ],
    related: ["geo-optimization", "content-seo", "seo", "technical-seo"],
  },
  ...
  // ---------------------------------------------------------------- GEO OPTIMIZATION
  {
    ...
    category: "marketing",
    iconName: "Globe",
    metaTitle: "GEO Optimization - Rank in Google AI Overviews & AI Search",
    metaDescription:
      "Generative Engine Optimization for Google AI Overviews, Bing Copilot, and AI-generated search results. Get your brand cited at the top of AI-powered search before your competitors do.",
    keywords: [
      "GEO optimization",
      "generative engine optimization",
      "Google AI Overviews optimization",
    ...
    heroTitle: "Show up in Google AI Overviews — before your competitors do",
    heroDescription:
      "Generative Engine Optimization targets Google AI Overviews, Bing Copilot, and AI-generated search summaries — the new zero-click layer that appears before organic results.",
    lede: "Google AI Overviews now appear for over 25% of searches and they answer the question before anyone clicks. Brands that aren't cited in those overviews are invisible for that query — even if they rank #1 in the organic results below. GEO is the work that gets you into the AI answer, not just the list underneath it.",
    deliverables: [
      { iconName: "Globe", title: "AI Overview appearance audit", description: "Systematic GSC + manual testing to find which queries for your brand trigger AI Overviews and whether you're being cited in them. Gap report against competitors." },
      { iconName: "FileSearch", title: "Passage-level content optimisation", description: "AI Overviews cite specific passages, not whole pages. Content is restructured so authoritative, standalone-readable passages exist for every target query." },
      { iconName: "Sparkles", title: "Entity & authority signals", description: "E-E-A-T signals, author pages, About pages, brand mentions, and structured entity data — the trust signals that determine which sources Google's AI pulls from." },
      { iconName: "Layers", title: "Schema markup for AI extractability", description: "FAQ, HowTo, Article, Speakable, and Organization schema so Google's AI can identify and extract your content with high confidence." },
      { iconName: "Search", title: "Semantic content structure", description: "Topic coverage, semantic keyword depth, and question-answer formatting so your content satisfies the full intent of AI Overview queries, not just a surface-level match." },
      { iconName: "BarChart3", title: "AI Overview tracking", description: "Weekly monitoring of AI Overview appearances for your target queries. Citation frequency, competitor citations, and trends — reported monthly." },
    ],
    techStack: [
      { label: "Audit", items: ["Google Search Console", "Screaming Frog", "Ahrefs", "Manual SERP sampling"] },
      { label: "Content", items: ["SurferSEO", "Clearscope", "ContentHarmony", "Semantic analysis"] },
      { label: "Schema", items: ["JSON-LD", "FAQ schema", "Speakable", "Article schema"] },
      { label: "Tracking", items: ["GSC", "Ahrefs AI Overview tracker", "Manual sampling", "Looker Studio"] },
    ],
    process: [
      { title: "AI Overview baseline", description: "Which of your target queries trigger AI Overviews, who's cited, and whether you appear. Competitor citation analysis across top 20 queries." },
      { title: "Passage & entity gap", description: "What content Google is pulling from, what entities it trusts, and what your site is missing to be a citation candidate." },
      { title: "Content & schema", description: "Passage restructuring, semantic content depth, FAQ and schema markup deployed. All prioritised by traffic value of the target query." },
      { title: "Track & iterate", description: "Weekly AI Overview spot-checks, monthly full re-baseline, continuous content improvement on underperforming passages." },
    ],
    proof: [
      { value: "AI Overview", label: "Tracked weekly for your priority queries" },
      { value: "Passage-level", label: "Content optimised for how AI extracts answers" },
      { value: "E-E-A-T", label: "Authority signals built into every content piece" },
      { value: "Reported", label: "Monthly citation frequency report vs competitors" },
    ],
    pricing: [
      { name: "GEO Audit", startingFrom: "$550", bestFor: "Baseline + priority plan", bullets: ["AI Overview appearance audit", "Competitor citation analysis", "Prioritised content fix list"] },
      { name: "GEO Sprint", startingFrom: "$2,800", popular: true, bestFor: "8-week appearance push", bullets: ["Audit + passage restructuring", "Schema + entity signals deployed", "Weekly tracking + monthly report"] },
      { name: "Retainer", startingFrom: "$1,400/mo", bestFor: "Sustained AI search presence", bullets: ["3-4 optimised pages/mo", "Weekly AI Overview monitoring", "Schema upkeep + new-page reviews"] },
    ],
    faqs: [
      { q: "What are Google AI Overviews?", a: "AI Overviews (formerly Search Generative Experience) are the AI-generated summary answers Google shows at the top of search results, above the organic blue links. They appear for over 25% of queries and include citations to sources. Being cited there drives impressions and traffic even when users don't scroll to your organic listing." },
      { q: "Does ranking in organic results help with AI Overviews?", a: "It's a factor but not the only one. Google's AI cites pages that have high E-E-A-T signals, clear passage-level answers, and strong semantic relevance — not just those that rank #1. Pages outside the top 10 can still appear in AI Overviews if their content is the best direct answer." },
      { q: "Can I opt out of AI Overviews?", a: "Yes — you can use the 'nosnippet' meta tag to prevent your content from appearing in AI Overviews. But for almost every business, being cited in AI Overviews is a visibility advantage, not a risk." },
      { q: "How long does GEO take to show results?", a: "AI Overview citations can change within weeks as Google re-evaluates content quality. Schema and passage changes that improve extractability tend to pick up faster than new content that needs to build authority. Plan for 6-10 weeks to see meaningful change in citation frequency." },
    ],
    related: ["aeo-optimization", "seo", "technical-seo", "content-seo"],
  },
  ...
  // ---------------------------------------------------------------- CRO
  {
    ...
    category: "marketing",
    iconName: "Target",
    metaTitle: "Conversion Rate Optimization Services - CRO for SaaS & B2B",
    metaDescription:
      "Conversion rate optimization for SaaS, B2B, and e-commerce. Heatmaps, A/B testing, funnel analysis, and UX fixes that turn more of your existing traffic into leads and customers.",
    keywords: [
    ...
    eyebrow: "Conversion Rate Optimization",
    heroTitle: "More revenue from the traffic you already have",
    heroDescription:
      "Heatmaps, session recordings, A/B tests, and funnel analysis — the work that turns more of your existing visitors into leads, trials, and customers without spending more on ads or SEO.",
    lede: "Most growth budgets go to acquiring more traffic. CRO is the lever nobody pulls: if your landing page converts at 2% and you fix it to 4%, you doubled your leads from the same ad spend. That's not a small win — it's a multiplier on everything else you do.",
    deliverables: [
      { iconName: "BarChart3", title: "Funnel analysis & drop-off mapping", description: "GA4 funnel visualisation, session recordings, and scroll depth — mapped to your specific conversion goals to show exactly where users leave and why." },
      { iconName: "Target", title: "Heatmap & click analysis", description: "Hotjar or Clarity heatmaps, rage-click detection, and attention maps per page. Visual evidence for what your users actually do vs what you thought they would." },
      { iconName: "Zap", title: "A/B test design & execution", description: "Hypothesis-driven A/B tests on headlines, CTAs, pricing page layout, form length, and social proof placement. Statistical significance before declaring a winner." },
      { iconName: "Layers", title: "Landing page UX audit", description: "Message match, CTA clarity, social proof placement, friction points, and above-the-fold value proposition — reviewed against conversion psychology frameworks." },
      { iconName: "FileSearch", title: "Form & checkout optimisation", description: "Field reduction, progressive disclosure, inline validation, autofill, trust signals, and exit-intent interventions. The fastest wins on most B2B and e-commerce sites." },
      { iconName: "TrendingUp", title: "Revenue attribution", description: "GA4 conversion events wired correctly so you know which traffic source, page, and CTA actually generates revenue — not just sessions and pageviews." },
    ],
    techStack: [
      { label: "Analysis", items: ["GA4", "Hotjar", "Microsoft Clarity", "FullStory"] },
      { label: "Testing", items: ["Google Optimize (replaced)", "VWO", "Optimizely", "Split.io"] },
      { label: "Attribution", items: ["GA4 Events", "Looker Studio", "PostHog", "Amplitude"] },
      { label: "Implementation", items: ["Next.js", "GTM", "Vercel Edge Config", "Stripe"] },
    ],
    process: [
      { title: "Baseline & funnel map", description: "GA4 funnel setup, heatmaps installed, and session recordings reviewed. Which pages and steps lose the most value." },
      { title: "Hypothesis list", description: "Ranked list of testable changes by expected impact and implementation effort. Prioritise high-impact / low-effort wins first." },
      { title: "Test & iterate", description: "Run A/B tests in order of priority, minimum 2 weeks per test, statistical significance required to declare a winner. Losers inform the next hypothesis." },
      { title: "Implement & attribute", description: "Winners shipped permanently, GA4 conversion events validated, Looker Studio report built. Revenue per visit is the number that matters." },
    ],
    proof: [
      { value: "+35%", label: "Median conversion rate lift on priority landing pages" },
      { value: "Data-driven", label: "Every test based on heatmap + funnel data, not opinion" },
      { value: "2 weeks", label: "Minimum A/B test duration before calling a winner" },
      { value: "Revenue", label: "Tracked — not just form submissions" },
    ],
    pricing: [
      { name: "CRO Audit", startingFrom: "$650", bestFor: "1-3 priority pages", bullets: ["Heatmap setup + analysis", "Funnel drop-off report", "Prioritised recommendation list"] },
      { name: "CRO Sprint", startingFrom: "$3,200", popular: true, bestFor: "6-week testing program", bullets: ["Full funnel audit", "3-5 A/B tests run", "GA4 conversion events wired", "Final implementation of winners"] },
      { name: "Retainer", startingFrom: "$1,800/mo", bestFor: "Ongoing experimentation", bullets: ["2-3 A/B tests/mo", "Monthly funnel + revenue report", "Continuous landing page iteration"] },
    ],
    faqs: [
      { q: "How much traffic do I need for A/B testing to work?", a: "A meaningful A/B test typically needs 300-500 conversions per variant to reach statistical significance. For low-traffic sites, I focus on UX audits and expert reviews first — A/B tests on thin data can mislead more than they help." },
      { q: "How is CRO different from UX design?", a: "UX design is about how the product feels to use. CRO is about measurable conversion outcomes — form completions, trial signups, purchases. CRO uses UX principles but validates every change with data, not intuition." },
      { q: "Can you help with both landing pages and the product funnel?", a: "Yes. Landing page CRO (ads, SEO traffic) and product funnel CRO (onboarding, activation, upsell) are both in scope. The tools and hypotheses differ, but the methodology is the same: measure, hypothesise, test, ship winners." },
      { q: "What's a realistic conversion lift I can expect?", a: "Highly site-dependent. Sites with significant UX issues see 30-50%+ lifts on priority pages. Well-optimised sites might see 10-15%. I benchmark against your current rate and give an honest projection before starting, not after." },
    ],
    related: ["seo", "aeo-optimization", "web-development", "landing-page-development"],
  },
];
